...
Agent/TCP/FullTcp set ecn_syn_ 1
Agent/TCP/FullTcp set PrioThresh 4380

Queue/DoubleQueue set thersh1_ 5;
Queue/DoubleQueue set thresh2_ 20;
...
$ns simplex-link $nqueue $nclient $lineRate [expr $RTT/4] DoubleQueue
