...
const int PIAS_QDISC_ECN_THRESH_BYTES=30*1024;

/* We use 995Mbps for Gigabit link with the hope of having small queues in the NIC.*/
const int PIAS_QDISC_RATE_MBPS=995;

/* The bucket size in nanoseconds */
const int PIAS_QDISC_BUCKET_NS=1000000;

/* Maximum sum of queue lenghs. 1MB should be enough */ 
const int PIAS_QDISC_MAX_LEN_BYTES=1024*1024;

 /* DSCP values for different priorities */
const int PIAS_QDISC_PRIO_DSCP_1=7;
const int PIAS_QDISC_PRIO_DSCP_2=6;
const int PIAS_QDISC_PRIO_DSCP_3=5;
const int PIAS_QDISC_PRIO_DSCP_4=4;
const int PIAS_QDISC_PRIO_DSCP_5=3;
const int PIAS_QDISC_PRIO_DSCP_6=2;
const int PIAS_QDISC_PRIO_DSCP_7=1;
const int PIAS_QDISC_PRIO_DSCP_8=0;
